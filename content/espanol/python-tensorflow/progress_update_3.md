...
draft: false
---
¡Buen trabajo! ¡Ya casi llegas al final!

Para verificar que tu código es correcto hasta este punto de control, compara tu código con el código de ejemplo que se muestra a continuación.
...
Si deseas probar el código anterior, visita <a href="https://colab.research.google.com/drive/1yrUcfMw8H9XbfJ8USITjErpRpBQrl_Sf?usp=sharing" target="_blank">este enlace</a>
...
Una vez que hagas una copia, por favor asegúrate de reemplazar "Copy of" por tu nombre, junto con el nombre del archivo. Esto aparecerá en la esquina superior izquierda de tu cuaderno.
{{% /notice %}}
